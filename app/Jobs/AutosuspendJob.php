...
class AutosuspendJob implements ShouldQueue
{
    ...
    */
    ...
    public function handle()
    {
            ...
            $LOG_ACTIVITY = LogActivity::create([
                ...
                'log_entry' => 'Auto Deactivated subscription, with subscribtion id :'.$this->subscription_id.', reason: karena tagihan belum dibayarkan sampai jatuh tempo, response: '. $message,

            ...
            <div class="card-body">
                <div class="row align-items-center g-2">
                    ...
                    <div class="col-8 col-sm-5 col-md-4 col-lg-3">
                        <input type="text" class="form-control" name="billing_account" value="{{ Request::get('billing_account') }}" placeholder="Enter Billing Account Number *" required>
                    </div>
...
@include('component.canvas.filter-invoices-publish')

...
<div class="page-body">
    ...
    <div class="container-xl">
                    ...
                    <div class="col">
                        ...
                        <div class="text-secondary">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li>
                                    <h3 class="text-green">Statistic - Day</h3>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <form method="GET" action="/console/subscription/statistic/perday" id="form-salesorder">
            <div class="row">
                <div class="col-xl-2">
                    <div class="input-icon mb-2">
                        <input class="form-control filter_day" name="filter_day" placeholder="Today"
                            id="datepicker-icon" />
            ...
            <div class="table-responsive">
                <table class="table table-vcenter table-bordered table-nowrap card-table">
                    ...
                    <tbody>
                        ...
                        $total_dismentle = 0;
                        ?>
                        @forelse($stats_perday as $stat => $sday)
                            <?php 

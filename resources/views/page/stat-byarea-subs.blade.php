...
<div class="page-body">
    ...
    <div class="container-xl">
        ...
        <form method="GET" action="/console/subscription/statistic_area/peryear" id="form-salesorder">
            <div class="row">
                <div class="col-xl-2">
        ...
        <div class="row row-cards">
            <div class="col-md-2">
                <div class="card">
                    <div class="card-body">
                        <h3 style="margin-bottom:2px;">Total Subscription</h3>
                        ...
                        <tbody>
                            ...
                            @forelse($month_list as $raw)
                                <tr>
                                    ...
                                    <td>{{ $raw['count'] }} Subscription</td>
                                    @if(session('role_id') == 3 || session('role_id') == 4)
                                    <td>
                                        <a href="{{ url('/') }}/console/subscription?year={{ $year }}&month={{ $raw['number'] }}&filter_area={{ $filter_area }}"
                                            class="dropdown">

...
<div class="page-body">
    ...
    <div class="container-xl">
        ...
        <div class="page-header d-print-none">
            <div class="container">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-2">
                        <a href="{{ url('/console/invoices/stat/peryear') }}"
                    ...
                    <div class="col-2">
                        <a href="{{ url('/console/invoices/stat/byyear') }}"
        ...
        <form method="GET" action="/console/invoices/stat/peryear" id="form-salesorder">
            <div class="row">
                <div class="col-xl-2">
        ...
        <div class="row row-cards">
            <div class="col-md-2">
                <div class="card">
                    <div class="card-body">
                        <h3 style="margin-bottom:2px;">Total Revenue </h3>
                        <span class="badge bg-azure-lt">/ {{ $year }} </span>
                        <div class="h1 m-0">{{ $total_paid }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card">
                    <div class="card-body">
                        <h3 style="margin-bottom:2px;">Total COGS </h3>
                        <span class="badge bg-azure-lt">/ {{ $year }} </span>
                        <div class="h1 m-0">{{ $cogs }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card">
                    <div class="card-body">
                        <h3 style="margin-bottom:2px;">Total Profit </h3>
                        <span class="badge bg-azure-lt">/ {{ $year }} </span>
                        <div class="h1 m-0">{{ $profit }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <h3>Revenue Transaction by Month</h3>
                        ...
                        <tbody>
                            ...
                            @forelse($month_list as $raw)
                                <tr>
                                    ...
                                    <td>IDR. {{ number_format($raw['revenue'], 0) }}</td>
                                    <td>IDR. {{ number_format($raw['cogs'], 0) }}</td>
                                    <td>IDR. {{ number_format($raw['profit'], 0) }}</td>
                                    @if(session('role_id') == 3 || session('role_id') == 4)
                                    <td>
                                        <a href="{{ url('/') }}/console/invoices/list/publish?year={{ $year }}&month={{ $raw['number'] }}"
                                            class="dropdown">

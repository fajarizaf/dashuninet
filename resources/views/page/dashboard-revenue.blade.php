    ...
    <div class="container-xl">
        <div class="row g-2 mb-4">
            <div class="col-12 mb-1">
                <div class="fw-bold fs-3">Total Revenue</div>
            </div>
            <div class="col-6 col-sm-auto">
                <div class="p-2 rounded border border-primary bg-primary text-white shadow-sm">
                    <div class="text-light small fw-medium">Income (IDR)</div>
                    <div class="fs-3 fw-bold">800.000.000</div>
                </div>
            </div>
            <div class="col-6 col-sm-auto">
                <div class="p-2 alert alert-warning border-warning bg-white m-0 shadow-sm">
                    <div class="text-secondary small fw-medium">COGS (IDR)</div>
                    <div class="fs-3 fw-bold">500.000.000</div>
                </div>
            </div>
            <div class="col-6 col-sm-auto">
                <div class="p-2 alert alert-success border-success bg-white m-0 shadow-sm">
                    <div class="text-secondary small fw-medium">Profit (IDR)</div>
                    <div class="fs-3 fw-bold">300.000.000</div>
                </div>
            </div>
            <div class="col-12 col-sm-auto ms-auto text-center">
                <div class="px-3 py-1 rounded border border-vk bg-vk text-white shadow-sm">
                    <div class="text-light small fw-medium">TODAY (IDR)</div>
                    <div class="fs-2 fw-bold">300.000.000</div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="bg-white p-2 rounded my-1 shadow-sm">
                <div class="row g-1">
                    <div class="col-12 col-lg-3 col-xxl-2 fw-medium fw-bold me-auto text-secondary">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 col-xxl-2 text-end">
                        <span class="badge text-primary border border-2 fw-normal">Income (IDR) : <text class="fw-bold">800.000.000</text></span>
                    </div>
                    <div class="col-12 col-sm-4 col-lg-3 col-xxl-2 text-end">
                        <span class="badge fw-normal">COGS (IDR) : <text class="fw-bold text-warning">800.000.000</text></span>
                    </div>
                    <div class="col-12 col-sm-4 col-lg-3 col-xxl-2 text-end">
                        <span class="badge fw-normal">Profit (IDR) : <text class="fw-bold text-success">800.000.000</text></span>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <hr class="pt-1 bg-secondary border-0" />

        <div class="row">
            <div class="col-12 mb-3">
                <div class="row align-items-center justify-content-between g-2">
                    <div class="col-auto fw-bold fs-3 me-auto">Revenue By Project Area - <u>Vila Dago</u></div>
                    <div class="col-auto">
            ...
            <div class="col-12 mb-3">
                <div class="rounded bg-white p-4 shadow-sm">
                    <div class="row g-2">
                        <div class="col-12">
                            <div class="mb-3 row g-1 small">
                                <div class="col-6 col-sm-auto">
                                    <div class="bg-primary text-nowrap text-start border border-primary py-1 px-2 rounded text-white">
                                        <small class="fw-normal">Income (IDR)</small>
                                        <div class="fs-4 fw-bold">800.000.000</div>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-auto">
                                    <div class="bg-muted-lt text-nowrap text-start border border-warning py-1 px-2 rounded text-warning">
                                        <small class="fw-normal">COGS (IDR)</small>
                                        <div class="fs-4 fw-bold">800.000.000</div>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-auto">
                                    <div class="bg-muted-lt text-nowrap text-start border border-success py-1 px-2 rounded text-success">
                                        <small class="fw-normal">Profit (IDR)</small>
                                        <div class="fs-4 fw-bold">800.000.000</div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-auto ms-sm-auto">
                                    <div class="text-bg-vk text-nowrap text-center py-1 px-2 rounded text-white">
                                        <small class="fw-normal">TODAY (IDR)</small>
                                        <div class="fs-3 fw-bold">800.000.000</div>
                                    </div>
                                </div>
                            </div>

                            <div style="overflow-y: scroll;max-height: 475px;">
                                @for($i=1;$i<=12;$i++)
                                    <div class="bg-muted-lt p-2 rounded my-1 small">

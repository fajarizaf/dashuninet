        ...
        <div class="row g-2 align-items-center">
            <div class="col-auto col-sm-5 col-md-6 col-lg-auto">
                <div>
                    ...
                    <h2 class="page-title">Incoming Order</h2>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 text-end">
                                ...
                                <span class="dropdown">
                                    <a href="{{ url('/') }}/console/salesorder/take/{{$raw->id}}">
                                        <button class="btn btn-outline-warning">Take</button>
                                    </a>
                                </span>
                                @endif
                            </td>
...
@include('component.canvas.filter-salesorder-incoming')

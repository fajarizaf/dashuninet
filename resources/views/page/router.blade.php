            ...
            <div class="col-auto">
                <div class="d-flex gap-2 align-items-center justify-content-between justify-content-sm-start">
                    <div>
                        ...
                        <h2 class="page-title">Project Router</h2>
                    </div>
                </div>
            </div>
            <div class="col-auto">
                <div class="d-flex gap-2">
                    ...
                    <a href="#" id="btn-create-so" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-addrouter">
                        ...
                        <span class="d-none d-sm-inline">&nbsp;Add New Router</span>
                    </a>
                    @endif
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        @forelse($data as $raw)
                            <tr>
                                ...
                                <td class="py-2 text-center">{{ $raw->ipaddress }}</td>
                                <td class="py-2 text-center"><span class="badge">{{ $raw->username }}</span></td>
                                <td class="py-2 text-center"><span class="badge">{{ $raw->password }}</span></td>
                                ...
                                <td class="py-2 text-end">
                                    <button class="btn btn-outline-primary btnedit" router_id="{{ $raw->id }}" title="Edit">Edit</button>
                                </td>
                            </tr>
                        @empty
...
@include('component.modal.add-router')
@include('component.modal.edit-router')
...
<script>
    $(document).ready(function () {
        ...
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('#form-router').find('input[name="_token"]').first().val()
            }
        });
        ...
        $('.btnedit').click(function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('router_detail') }}",
                data: {
                    router_id: router_id
                },
                success: function (data) {
                    $('#modal-editrouter').modal('show');

<div class="modal modal-blur fade" id="modal-upload-spk" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            <form method="POST" action="/console/salesorder/upload/document" enctype="multipart/form-data">
                ...
                <input type="text" style="display:none" name="document_type" value="spk" />      
                
                <div class="modal-header">
                    <h5 class="modal-title">Upload Document SPK</h5>

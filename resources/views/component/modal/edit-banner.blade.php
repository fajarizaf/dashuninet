<div class="modal modal-blur fade" id="modal-editbanner" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">

            <form enctype="multipart/form-data" method="POST" action="/console/banner/update" id="form-banner">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control banner_name" name="banner_name"
                            placeholder="Input Banner Name" required>
                    </div>

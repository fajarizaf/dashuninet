<div class="offcanvas offcanvas-start" tabindex="-1" id="duedate" aria-labelledby="offcanvasStartLabel"
    ...
    <div class="offcanvas-body">
        <div class="col-md-6 col-xl-12">
            ...
            <form method="GET" action="/console/invoices/list/duedate" id="form-salesorder">
                <div class="mb-3">

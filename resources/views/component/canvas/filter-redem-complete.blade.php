<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart" aria-labelledby="offcanvasStartLabel"
    ...
    <div class="offcanvas-body">
        <div class="col-md-6 col-xl-12">
            ...
            <form method="GET" action="/console/redem/complete" id="form-salesorder">
                <div class="mb-3">
                    <label class="form-label">Customer Request</label>
                    <div class="input-icon mb-3">
                        <input type="text" value="" name="customer_request" class="form-control">
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label">Redem Status</label>
                    <select class="form-select" name="redem_status" id="action_type" aria-label="Floating label select example">

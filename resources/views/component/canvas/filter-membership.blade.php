<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart" aria-labelledby="offcanvasStartLabel"
    ...
    <div class="offcanvas-body">
        <form method="GET" action="/console/customer/membership" id="form-salesorder">
            <div class="col-md-6 col-xl-12">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-icon mb-3">
                        <input type="text" value="" name="member_name" class="form-control">
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label">Member Status</label>
                    <select type="text" class="form-select" name="member_status">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-icon mb-3">
                        <input type="text" value="" name="customer_number" class="form-control">
                    </div>
                </div>

<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart" aria-labelledby="offcanvasStartLabel"
    ...
    <div class="offcanvas-body">
        <div class="col-md-6 col-xl-12">
            ...
            <form method="GET" action="/console/salesorder" id="form-salesorder">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select type="text" class="form-select" id="select-product-filter" name="product_name">
                        ...
                        @forelse($product_filter as $group)
                            <option value="{{ $group->id }}">{{ $group->product_name }} -
                                {{ $group->product_plan }} ( {{ $group->product_type }} )
                            @empty
                ...
                <div class="mb-3">
                    ...
                    <div class="filter-plan">
                        <div class="alert alert-important alert-info alert-dismissible" role="alert">
                            <div class="d-flex">
                                <div>
                                    <!-- Download SVG icon from http://tabler-icons.io/i/info-circle --><svg
                ...
                <div class="mb-3">
                    <label class="form-label">Target To Live</label>
                    <input type="date" class="form-control" name="target_to_live">
                </div>
    ...
    $(document).ready(function () {
        ...
        $.ajaxSetup({
            headers: {
                ...
                'X-CSRF-TOKEN': $('#form-like  ').find('input[name="_token"]').val()
            }
        });

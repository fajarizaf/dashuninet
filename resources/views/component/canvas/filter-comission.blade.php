<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart" aria-labelledby="offcanvasStartLabel"
    ...
    <div class="offcanvas-body">
        <div class="col-md-6 col-xl-12">
            ...
            <form method="GET" action="/console/salesorder/list/commission" id="form-salesorder">
                <div class="mb-3">
                    <label class="form-label">Sales Name</label>
                    <div class="input-icon mb-3">
                        <input type="text" value="" name="sales_name" class="form-control">
                    </div>
                </div>


                <div class="mb-3">
                    <label class="form-label">Ready To Process</label>
                    <select type="text" class="form-select" name="ready">
                ...
                <div class="mb-3">
                    ...
                    <select type="text" class="form-select" name="payment_status">
                        <option value="">-- Select --</option>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-icon mb-3">
                        <input type="month" id="start" name="datepaid" min="2024-01" class="form-control">
                    </div>
                </div>
